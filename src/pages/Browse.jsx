    ...
    return (
      <>
       ...
       hidden lg:block arrow-btn "
            ...
            <div
              ref={scrollRef}
              className=" grid lg:grid-rows-2 lg:grid-cols-none scroll-smooth grid-cols-2  lg:grid-flow-col-dense gap-[1.0rem] w-full px-[1.0rem] overflow-x-scroll scroll-hide">
              {playlists.map((genre) => (
