    ...
    return (
      <>
       ...
       hidden lg:block arrow-btn "
            ...
            <div
              ref={scrollRef}
              className=" grid lg:grid-rows-3 lg:grid-cols-none scroll-smooth grid-cols-3  lg:grid-flow-col-dense gap-[1.4rem] w-full px-[1.4rem] overflow-x-scroll scroll-hide">
              {playlists.map((genre) => (
